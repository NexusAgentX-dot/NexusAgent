...
export const demoApprovedRun: WorkflowRun = {
  ...
  events: [
    ...
    },
    {
      ...
      description: 'x402 payment settled on-chain via OKX facilitator for signal access.',
  ...
  settlement: {
    ...
    proofSummary:
      'Live X Layer mainnet settlement: 0.01 USDT bounded transfer verified on OKLink explorer.',
  },
}
...
export const PROTOCOL_STACK = [
  ...
  {
    name: 'ERC-8004',
    desc: 'On-chain agent identity registry (Draft standard)',
    layer: 'Identity',
  },
  {
    name: 'ERC-8183',
    desc: 'Agentic commerce escrow (Draft standard)',
    layer: 'Commerce',
  },
]
