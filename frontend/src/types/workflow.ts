...
export type PaymentMode =
  | 'x402_live'
  | 'transfer_event'
  | 'x402_compatible_demo' // legacy: kept for stored alpha data backward compatibility
...
export type ActivationState = 'draft' | 'active' | 'disabled'
export type WalletVerificationState = 'pending' | 'accepted' | 'failed'
