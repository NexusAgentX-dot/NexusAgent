...
export default function Hero() {
  ...
  useEffect(() => {
    getOKBSignal().then((s) => { if (s) setSignal({ price: s.price, change24h: s.change24h }) })
  }, [])
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-24 pb-20">
        ...
        <p className="text-center text-lg md:text-xl text-text-secondary max-w-3xl mx-auto mb-6 leading-relaxed anim-fade-up anim-d2">
          ...
          coordinate through open standards, support x402-compatible payment flows, and settle outcomes onchain.
        </p>

        <p className="text-center text-sm text-text-tertiary max-w-2xl mx-auto mb-10 anim-fade-up anim-d3">
          Not a single bot. Not a chatbot with a wallet. A standards-aligned framework where
          specialized agents collaborate, pay, execute, and prove work on X Layer.
        </p>
