...
assert(verifySentinel.walletVerificationState === "verified", "wallet verification did not verify the sentinel agent");
assert(verifyArbiter.walletVerificationState === "verified", "wallet verification did not verify the arbiter agent");
assert(verifyExecutor.walletVerificationState === "verified", "wallet verification did not verify the executor agent");
assert(verifyEvaluator.walletVerificationState === "verified", "wallet verification did not verify the evaluator agent");
