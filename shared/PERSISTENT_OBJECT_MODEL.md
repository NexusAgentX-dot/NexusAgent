...
## Purpose
This file defines the minimum persistent objects required to move NexusAgent from demo mode to private builder alpha.
...
For private builder alpha, file-backed persistence is acceptable.
