...
export const activationStateValues = ['draft', 'verified', 'active', 'disabled'] as const
export const walletVerificationStateValues = ['unverified', 'pending', 'verified', 'failed'] as const
